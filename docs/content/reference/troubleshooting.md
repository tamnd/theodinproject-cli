...
Most of these come down to network reality or how theodinproject serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

theodinproject rate-limits like any public site. theodinproject already paces
...
Where a surface is gated, theodinproject reads a cookie or token you supply
...
`theodinproject`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what theodinproject actually did
